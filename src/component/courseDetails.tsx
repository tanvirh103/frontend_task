...
export default function CourseInstructor({ data }: { data: any }) {
  return (
    <div className="container mx-auto px-44 pb-16">
      ...
      <div className="border-border-color border rounded-lg px-4 py-4 md:max-w-[calc(100%_-_348px)] lg:max-w-[calc(100%_-_448px)] mt-4">
        {data.data.sections
          .filter((s: any) => s.type === "instructors")
          .map((instructor: any) => (
            <div key={instructor.values[0]} className="flex gap-4 items-center">
