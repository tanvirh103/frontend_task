...
export default function Navbar(){
    return(
          <div className="w-full bg-white px-4 py-2 border-border-color border-b">
        <div className="container mx-auto flex justify-between px-20">
          ...
          <div className="hidden md:flex gap-4 items-center">
            <p className="items-center text-center w-12 h-8 border-border-color border flex">
              <svg
              ...
              <span className="text-sm font-normal">বাং</span>
            </p>
